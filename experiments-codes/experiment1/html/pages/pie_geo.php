...
<head>
    ...
    <title>Geometric Texture Pie Chart</title>
...
<div class="container">
    ...
    <div class="row">
        <div class="col">
            <button id="pie_geo_next_btn" class="btn btn-primary float-end">Next
            </button>
        </div>
    </div>
</div>
...
<script>
    ...
    document.getElementById('pie_geo_next_btn').onclick = function(){

        //write data to measurements
        // measurements['parameters_pie_geo'] = JSON.stringify(parameters)
        // measurements['timestamp_design_finished_pie_geo'] = Date.now()

        let timestamp_pie_geo_end = Date.now() //the end time for this design
        let pie_geo_design_time = timestamp_pie_geo_end - timestamp_pie_geo_start // time used for this design
        ...
        let obj = {}
        obj.svgData = svgData
        obj.filename = 'pie_geo_'+ measurements['participant_id'] + '_v' + measurements['trial_num']
        ...
        //jump to next page
        switch (condition_texture){
            case 0: //geo_icon: this design (pie_geo) is the first design

                measurements['first_design_time'] = pie_geo_design_time
                ...
                break;
            case 1: //icon_geo: this design (pie_geo) is the second design

                measurements['second_design_time'] = pie_geo_design_time
