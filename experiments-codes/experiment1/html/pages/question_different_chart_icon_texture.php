...
<div class="container">
    <div class="row">
        <div class="col">
            <h2>Different Chart Type - Iconic texture</h2>
            <div class="alert alert-info already_answered_before" role="alert" style="display: none">
                ...
                <button id="different_chart_icon_same_answer_btn" class="btn btn-outline-dark btn-sm">Same As Before</button>
            </div>

            <p>We applied the iconic texture you designed to <span id="another_charts"></span>. </p>
        ...
        <div class="col">
            ...
            <div class="mb-3">
                    <textarea class="form-control"
                              id="different_chart_icon_textarea"
                              rows="4"
                              cols="80"
                              placeholder="Please write your answer here."
                    ></textarea>
            </div>
            <button id="different_chart_icon_next_btn" class="btn btn-primary float-end" disabled>Next</button>
        </div>
    </div>
</div>
...
<script>
    ...
    document.getElementById('different_chart_icon_same_answer_btn').onclick = function (){
        //fill the textarea of questions on this page with "same"
        document.getElementById('different_chart_icon_textarea').value = 'same'

        //record the answer
        different_chart_icon_answer = 'same'

        //record the answer status
        different_chart_icon_answered = true

        //enable the next button
        document.getElementById('different_chart_icon_next_btn').disabled = false
    }
</script>
<script>
...
<script>
    let nextBtn = document.getElementById('different_chart_icon_next_btn')

    let different_chart_icon_answered = false
    let different_chart_icon_answer = 'no_input'

    document.getElementById('different_chart_icon_textarea').oninput = function (){
        if(this.value){
            different_chart_icon_answered = true
        }else{
            different_chart_icon_answered = false
        }

        different_chart_icon_answer = this.value

        if (different_chart_icon_answered){
    ...
    document.getElementById('different_chart_icon_next_btn').onclick = function(){
        //write data to measurements
        measurements['different_chart_icon'] = '"'+ different_chart_icon_answer + '"'
