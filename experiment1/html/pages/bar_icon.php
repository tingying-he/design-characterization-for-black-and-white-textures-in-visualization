...
<head>
    ...
    <title>Iconic Texture Bar Chart</title>
...
<div class="container">
    ...
    <div class="row">
        <div class="col">
            <button id="bar_icon_next_btn" class="btn btn-primary float-end">Next
            </button>
        </div>
    </div>
</div>
...
<script>
    ...
    document.getElementById('bar_icon_next_btn').onclick = function(){

        //write data to measurements
        // measurements['parameters_bar_icon'] = JSON.stringify(parameters)
        // measurements['timestamp_design_finished_bar_icon'] = Date.now()

        let timestamp_bar_icon_end = Date.now() //the end time for this design
        let bar_icon_design_time = timestamp_bar_icon_end - timestamp_bar_icon_start // time used for this design
        ...
        let obj = {}
        obj.svgData = svgData
        obj.filename = 'bar_icon_'+ measurements['participant_id'] + '_v' + measurements['trial_num']
        ...
        //jump to next page
        switch (condition_texture){
            case 0: //geo_icon: this design (bar_icon) is the second design

                measurements['second_design_time'] = bar_icon_design_time
                ...
                break;
            case 1: //icon_geo: this design (bar_icon) is the first design

                measurements['first_design_time'] = bar_icon_design_time
