...
<script>
    ...
    $('body').on('show', function(e, type){
        ...
        if (type === '<?php echo $id;?>'){
            ...
            trial_measure = new_trial(id, current_stimulus_index, question, texture, condition,chart_present_time);
    ...
    $('body').on('next', function(e, type){
        if (type === '<?php echo $id;?>'){
            ...
            let obj = createLoggingObj(measurements['participant_id'], //participant_id
                ...
                '<?php echo $textures_order_for_question0[$texture_index]; ?>', //texture_condition
